...
class TimelineService
{
     ...
     */
    public function prepareMongoArr($tree, $topic, $reviewTopic, $asOfDate, $algorithm, $topicCreatedByNickId, $message, $type, $id, $old_parent_id, $new_parent_id, $topic_name, $camp_num, $camp_name, $k, $rootUrl, $url)
    {
     ...
     * @return array $array
     */
    public function upsertTimeline($topicNumber, $algorithm, $asOfTime, $updateAll, $request, $message, $type, $id, $old_parent_id, $new_parent_id, $timelineType, $topic_name, $camp_num, $camp_name, $k = 0, $url = null)
    {
    ...
    public function getTimelineUrl($topic_num, $topic_name, $camp_num, $camp_name, $topicTitle, $type, $rootUrl, $namespaceId, $topicCreatedByNickId)
    {
        try {
            ...
            } elseif ($type == 'update_camp' || $type == 'parent_change') {
