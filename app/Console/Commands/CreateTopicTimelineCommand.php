...
class CreateTopicTimelineCommand extends Command
{
    ...
    public function handle()
    {
        ...
        $algorithms = AlgorithmServiceFacade::getAlgorithmKeyList('timeline', $algorithm_id);
        /*
        ...
        try {
            ...
            if (count($topics) > 1) {
                foreach ($topics as $key => $topic) {
                    ...
                    $conditions = TimelineServiceFacade::getTopicConditions($topic->topic_num);
