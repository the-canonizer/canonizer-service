...
class RemoveNonLatestTreesCommand extends Command
{
    ...
    public function handle()
    {
        ...
        try {
            ...
            $algorithms = (new AlgorithmServiceFacade)->getAlgorithmKeyList('tree');

            foreach ($algorithms as $algorithm) {
                // $topicsMongo = Tree::where('algorithm_id', $algorithm)->delete();
                $topicsWithScore = TopicRepositoryFacade::getTopicsWithPagination('', 0, $algorithm, 0, 0, '', 'default', '', '', false);
