...
class Topic extends Model
{
    ...
    {
        return $this->hasMany(Camp::class, 'topic_num', 'topic_num');
    }

    public function camps1()
    {
        return $this->hasMany(Camp::class, 'topic_num', 'topic_num')->groupBy('camp_num');
    }

    public function topic()
    {
        return $this->hasOne(Topic::class, 'topic_num', 'topic_num')->orderBy('go_live_time', 'DESC');
    }

    public function supports()
    {
        return $this->hasMany(Support::class, 'topic_num', 'topic_num')->orderBy('support_order', 'ASC');
    }
    ...
    {
        return $this->hasOne(Namespaces::class, 'id', 'namespace_id');
    }

    public function scopeGetsupports($query, $topic_num, $userNickname = null, $filter = [])
    {
        $as_of_time = time() + 100;
    ...
    public static function getHistory($topicnum, $filter = [])
    {

        return self::where('topic_num', $topicnum)->latest('submit_time')->get();
    }

    public static function getLiveTopic($topicnum, $filter = [])
    {
