...
class Algorithm
{
    ...
    {
        return ['blind_popularity', 'mind_experts', 'computer_science_experts', 'PhD', 'christian', 'secular', 'mormon', 'uu', 'atheist', 'transhumanist', 'united_utah', 'republican', 'democrat', 'ether', 'shares', 'shares_sqrt',
        ];
    }
    ...
    public static function camp_count($nick_name_id, $condition, $political = false, $topicnum = 0, $campnum = 0)
    {
        ...
        if ($cacheWithTime) {
            ...
            if ($political == true && $topicnum == 231 && ($campnum == 2 || $campnum == 3 || $campnum == 4)) {
                ...
                } elseif ($result[0]->support_order == 2) {
                    $total = $result[0]->countTotal / 4;
                } elseif ($result[0]->support_order == 3) {
                    $total = $result[0]->countTotal / 6;
                } elseif ($result[0]->support_order == 4) {
