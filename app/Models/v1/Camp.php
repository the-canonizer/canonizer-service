...
class Camp extends Model
{
    ...
    public function topic()
    {
        ...
        if ((isset($_REQUEST['asof']) && $_REQUEST['asof'] == 'review') || (Session::get('asofDefault') == 'review' && ! isset($_REQUEST['asof']))) {
            ...
            return $this->hasOne('App\Model\v1\Topic', 'topic_num', 'topic_num')->where('objector_nick_id', '=', null)->orderBy('submit_time', 'DESC');
        } else {
    ...
    {
        $topic = \App\Model\v1\Topic::getLiveTopic($topic_num, ['nofilter' => true]);
