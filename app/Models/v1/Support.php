...
class Support extends Model {
	...
	public function topic() {
        return $this->hasOne('App\Models\v1\Topic', 'topic_num', 'topic_num')->where('topic.objector_nick_id','=',NULL)->where('topic.go_live_time','<=',time())->orderBy('topic.submit_time','DESC');
    }
