...
class Statement extends Model
{
    ...
    public static function getHistory($topicnum, $campnum, $filter = [])
    {
    ...
    public static function getLiveStatement($topicnum, $campnum, $filter = [])
    {
        ...
        if ((isset($_REQUEST['asof']) && $_REQUEST['asof'] == 'default')) {
            ...
            if (session('asofDefault') == 'review') {
                ...
                return self::where('topic_num', $topicnum)
                    ...
                    ->orderBy('submit_time', 'desc')
                    ->first();
            } elseif (isset($_REQUEST['asof']) && $_REQUEST['asof'] == 'review') {
                ...
                return self::where('topic_num', $topicnum)
                    ...
                    ->orderBy('submit_time', 'desc')
                    ->first();
            } elseif (isset($_REQUEST['asof']) && $_REQUEST['asof'] == 'bydate') {
    ...
    public static function getAnyStatement($topicnum, $campnum, $filter = [])
    {
